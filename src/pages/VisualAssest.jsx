  ...
  return (
    <div>
      ...
      <div className="flex gap-3  mt-6">
        {/* Sidebar */}
        <div className="bg-[#222230] rounded-md p-4  gap-12 flex flex-col relative justify-start items-start w-[30%]">
          ...
          {/* Bottom content */}
          <div className="bg-[#2f2f3c] w-full p-3 rounded-md mt-20">
          ...
          {creative[activeStep]?.id === "background" && (
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="bg-[#2f2f3c] p-4 flex-col flex justify-center items-start gap-3">
...
AI-Generated Assets                  </h1>
  ...
  {aIGeneratedAssets.map((val, idx) => (
    <div key={idx} className="bg-[#2f2f3c] mt-5 rounded-lg overflow-hidden shadow-md">
      
      {/* Image Section */}
      <div className="h-[200px]">
        <img src={val} alt={`Asset-${idx}`} className="w-full h-full object-cover" />
      </div>
      
      {/* Buttons Section */}
      <div className="flex justify-between items-center px-4 py-3 bg-[#3a3a4a]">
        <button
          className="px-3 py-2  rounded-md flex gap-3 text-sm items-center text-white"
        >
