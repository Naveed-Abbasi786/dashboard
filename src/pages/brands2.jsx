    ...
    <div className="w-full p-4">
      ...
      <div className="w-full border-1 flex justify-between border-gray-700 mt-10 p-3">
        ...
        <div className="flex justify-center items-center gap-6">
          ...
          <button className="bg-[#e75050] p-2  px-6 rounded-md flex gap-2 justify-center items-center text-white">
            <img src={PlusIcon} alt="" className="w-4" /> Add New brand
          </button>
          <div className="flex gap-2">
            <button className="bg-[#e75050] p-2  !text-sm px-3 rounded-lg flex gap-2 justify-center items-center text-white">
              <img src={GridIcon} alt="" className="w-3" /> Grid
            </button>
            <button className="bg-[#2f2f3c] p-2  px-3 rounded-lg flex gap-2 justify-center items-center text-white">
  ...
  {data.map((item, idx) => (
    ...
    >
      ...
      <div className="p-4 flex flex-col gap-2">
        <h1 className="text-white font-semibold text-lg">{item.titile}</h1>
