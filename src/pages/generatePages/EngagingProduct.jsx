...
const [advanceShow,setAdvanceShow]=useState(false)
            ...
            <>
              <div className="flex justify-between items-center p-2">
                <div className="flex justify-center items-center gap-2">
                  ...
                  <div>
                    ...
                    Choose the video ratio that best fits your advertising platform.
                    </h5>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    >
                      <div>
                      <h3 className="font-semibold text-[17px]  leading-4">Portrait Video</h3>
                      <span className="text-[12px] leading-[20px]">3:5 ratio, great for social media feeds where vertical space is prioritized.</span>
                      </div>
                    ...
                    >
                      <div>
                      <h3 className="font-semibold text-[17px]  leading-4">Portrait Video</h3>
                      <span className="text-[12px] -leading-24">5:3 ratio, ideal for landscape-oriented content across various platforms like YouTube and presentations..</span>
                      </div>
  ...
  >
    <div>
      <h3 className="font-semibold text-[17px] leading-4">Start from Product Image</h3>
      <span className="text-[12px]">Upload a product image to let our AI handle the background ..</span>
    </div>
  ...
  >
    <div>
      <h3 className="font-semibold text-[17px] leading-4">Start from Product Photoshoot</h3>
      <span className="text-[12px]">Upload your product photoshoot and let our AI turn it into a stunning video.</span>
    </div>
...
<>
            ...
            <div>
              ...
              <div className="flex justify-start items-center gap-2">
                ...
                <div>
                  ...
                  <h5 className="text-gray-400 text-md">
                    Choose between AI-generated or manually customized video creation.
                  </h5>
                </div>
              </div>
  ...
  >
    <div>
      <h3 className="font-semibold text-[17px] leading-4">Fully AI-Driven</h3>
      <span className="text-[12px]">Get studio-quality videos instantly — no effort needed.</span>
    </div>
  ...
  >
    <div>
      <h3 className="font-semibold text-[17px] leading-4">Custom Instructions</h3>
      <span className="text-[12px]">Customize your video with prompts, resolution settings, and other options.</span>
    </div>
                                       ...
                                       <div className="flex items-center gap-3">
                                         ...
                                         <div>
                                           ...
                                           <p className="text-gray-400 text-sm">
                                             Provide details about your audience, call to action, tone, and any specific requests.
                                           </p>
                                         </div>
                                       </div>
...
<h1 className="text-white font-semibold">{val.title}</h1>
<p className="text-white text-sm">{val.dis
  }</p>
 <SelectButton
